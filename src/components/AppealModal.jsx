            ...
            {done ? (
              <div className="rounded-xl border border-emerald-500/40 bg-emerald-500/10 p-6 text-center">
                ...
                <p className="mt-1 text-sm opacity-70">
                  Администрация рассмотрит её и ответит в чате.
                </p>
              </div>
            ) : (
              <>
                ...
                <form action={handleSubmit} className="space-y-4">
                  ...
                  <label className="block text-sm">
                    ...
                    <textarea
                      ...
                      minLength={10}
                      maxLength={500}
                      placeholder="Опишите, что именно вы изменили, чтобы объявление соответствовало правилам…"
                      className="input"
                    />
                  ...
                  {error && (
                    <p className="rounded-lg border border-hot/40 bg-hot/10 p-2 text-sm text-hot">
                      {error}
                    </p>
                  )}
                  ...
                  <div className="flex gap-2 border-t border-white/10 pt-3">
                    ...
                    <button
                      disabled={pending}
                      className="btn flex-1 justify-center !bg-amber-600"
                    >
